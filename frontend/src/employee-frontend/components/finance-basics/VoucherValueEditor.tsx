...
import { createVoucherValue } from '../../generated/api-clients/invoicing'

const createVoucherValueResult = wrapResult(createVoucherValue)
    ...
    <Tr key="edit">
      ...
      <Td>
        ...
        <AsyncButton
          ...
          onClick={() =>
            createVoucherValueResult({
              body: parseFormOrThrow(editorState)
            })
          }
          onSuccess={() => {
            close()
